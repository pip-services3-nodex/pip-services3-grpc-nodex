    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this._client = null;
                throw new pip_services3_commons_nodex_2.ConnectionException(correlationId, "CANNOT_CONNECT", "Opening GRPC client failed").wrap(ex).withDetails("url", this._uri);
            }
        });
    }
    /**
...
GrpcClient._defaultConfig = pip_services3_commons_nodex_1.ConfigParams.fromTuples("connection.protocol", "http", "connection.host", "0.0.0.0", "connection.port", 3000, "options.request_max_size", 1024 * 1024, "options.connect_timeout", 10000, "options.timeout", 10000, "options.retries", 3, "options.debug", true);
